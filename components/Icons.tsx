...
export const CogIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15 0c0-4.142 3.358-7.5 7.5-7.5s7.5 3.358 7.5 7.5m-15 0c0 4.142 3.358-7.5 7.5-7.5s7.5-3.358 7.5-7.5M12 6.75v.007v-.007z" />
    </svg>
);
...
export const BriefcaseIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.075c0 1.313-.964 2.375-2.125 2.375H5.875C4.714 20.6 3.75 19.538 3.75 18.225V14.15M16.5 21V14.15M7.5 21V14.15m0 0l3.75-3.75 3.75 3.75M7.5 14.15l-3.75-3.75C1.654 8.275 2.963 5.4 5.875 5.4H18.125c3.038 0 4.22 2.875 1.943 5.15l-3.75 3.75" />
    </svg>
);

export const UserGroupIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.2952a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0zM18 18.72a9.094 9.094 0 01-7.5 0m7.5 0a9.094 9.094 0 00-7.5 0M12 12.72a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0zM12 12.72a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zM12 12.72a9.094 9.094 0 010-9.094m0 9.094a9.094 9.094 0 000-9.094" />
    </svg>
);
...
export const ScaleIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0012 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-19.5 0c1.01.143 2.01.317 3 .52m0 0v1.441a47.904 47.904 0 00-3 1.05M12 4.5v1.441a47.904 47.904 0 013 1.05m-3-1.05a47.904 47.904 0 00-3 1.05m6 0a47.904 47.904 0 013 1.05m0 0v1.441a47.904 47.904 0 01-3 1.05m-6-1.05v1.441a47.904 47.904 0 003 1.05m0 0a47.904 47.904 0 003 1.05M3 7.5v6M21 7.5v6m-18 0h18" />
    </svg>
);
...
export const ReceiptPercentIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-1.5h5.25m-5.25 0h3m-3 0h-1.5m3 0h.01M6.375 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21m-7.5 0h-1.5m14.25 0h1.5m-12.75 0h11.25m-1.5-18h-8.25a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 006.75 21h8.25a2.25 2.25 0 002.25-2.25V5.25A2.25 2.25 0 0015 3z" />
    </svg>
);
